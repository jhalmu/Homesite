defmodule Homesite.ThreatReputation.IpWatchlistEntry do
  @moduledoc """
  Schema for admin-managed IP watchlist.

  Allows admins to manually add IPs to a watchlist with
  ...
  @doc """
  Creates a changeset for an IP watchlist entry.
  """
